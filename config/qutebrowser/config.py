...
c.url.searchengines = {'DEFAULT': 'https://duckduckgo.com/?q={}', 'arch': 'https://wiki.archlinux.org/?search={}', 'github': 'https://github.com/search?q={}', 'google': 'https://www.google.com/search?q={}', 'wiki': 'https://en.wikipedia.org/wiki/{}', 'yt': 'https://www.youtube.com/results?search_query={}', 'packages': 'https://search.nixos.org/packages?type=packages&query={}', 'options': 'https://search.nixos.org/options?type=packages&query={}'}
