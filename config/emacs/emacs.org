...
#+BEGIN_SRC emacs-lisp
  (set-fontset-font t 'symbol (font-spec :family "Twitter Color Emoji") nil 'prepend)
#+END_SRC
...
The default startup screen is bland, let's replace it with a simplistic dashboard, configured by me.
