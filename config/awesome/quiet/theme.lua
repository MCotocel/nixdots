...
theme.window_switcher_client_width = 500 -- The width of one client widget
theme.window_switcher_client_height = 50 -- The height of one client widget
...
theme.window_switcher_name_forced_width = 500 -- The width of one title
...
theme.window_switcher_icon_width = 0 -- Thw width of one icon
