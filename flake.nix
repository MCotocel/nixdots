...

{
  ...
  inputs = {
    f2k.url =
      "github:fortuneteller2k/nixpkgs-f2k"; # F2K's packages. I use this for awesome-git, because Awesome is an awesome window manager
    home-manager.url =
            ...
            modules = [
              {
                nixpkgs.overlays = [
                  ...
                  (self: super: {
                    ...
                    }; # Visualiser support for NCMPCPP (it looks cool)
                  })
